...
var require_each = __commonJS((exports, module) => {
  ...
  exports.default = function(instance) {
    instance.registerHelper("each", function(context, options) {
      ...
      var { fn: fn2, inverse } = options, i2 = 0, ret = "", data = undefined, contextPath = undefined;
      if (options.data && options.ids) {
      ...
      if (context && typeof context === "object") {
        if (_utils.isArray(context)) {
          for (var j3 = context.length;i2 < j3; i2++) {
            if (i2 in context) {
          ...
          for (var it3 = iterator.next();!it3.done; it3 = iterator.next()) {
            newContext.push(it3.value);
          }
          context = newContext;
          for (var j3 = context.length;i2 < j3; i2++) {
            execIteration(i2, i2, i2 === context.length - 1);
...
var require_runtime = __commonJS((exports) => {
    ...
    var container = {
      ...
      program: function program(i2, data, declaredBlockParams, blockParams, depths) {
        ...
        if (data || depths || blockParams || declaredBlockParams) {
          programWrapper = wrapProgram(this, i2, fn2, data, declaredBlockParams, blockParams, depths);
  ...
  var wrapProgram = function(container, i2, fn2, data, declaredBlockParams, blockParams, depths) {
  ...
  var executeDecorators = function(fn2, prog, container, depths, data, blockParams) {
    if (fn2.decorator) {
      var props = {};
...
var require_handlebars_runtime = __commonJS((exports, module) => {
  ...
  var create = function() {
    var hb2 = new base.HandlebarsEnvironment;
    Utils.extend(hb2, base);
    hb2.SafeString = _handlebarsSafeString2["default"];
    hb2.Exception = _handlebarsException2["default"];
    hb2.Utils = Utils;
    hb2.escapeExpression = Utils.escapeExpression;
    hb2.VM = runtime;
    hb2.template = function(spec) {
      return runtime.template(spec, hb2);
    };
    return hb2;
  };
  exports.__esModule = true;
        ...
        switch (yystate) {
          ...
          case 9:
            this.$ = {
              ...
              value: yy.stripComment($$[$02]),
              strip: yy.stripFlags($$[$02], $$[$02]),
          ...
          case 10:
            ...
            break;
          case 11:
            this.$ = yy.prepareRawBlock($$[$02 - 2], $$[$02 - 1], $$[$02], this._$);
            break;
          case 12:
            this.$ = { path: $$[$02 - 3], params: $$[$02 - 2], hash: $$[$02 - 1] };
            break;
          case 13:
            this.$ = yy.prepareBlock($$[$02 - 3], $$[$02 - 2], $$[$02 - 1], $$[$02], false, this._$);
            break;
          case 14:
            this.$ = yy.prepareBlock($$[$02 - 3], $$[$02 - 2], $$[$02 - 1], $$[$02], true, this._$);
            break;
          case 15:
            this.$ = { open: $$[$02 - 5], path: $$[$02 - 4], params: $$[$02 - 3], hash: $$[$02 - 2], blockParams: $$[$02 - 1], strip: yy.stripFlags($$[$02 - 5], $$[$02]) };
            break;
          case 16:
            this.$ = { path: $$[$02 - 4], params: $$[$02 - 3], hash: $$[$02 - 2], blockParams: $$[$02 - 1], strip: yy.stripFlags($$[$02 - 5], $$[$02]) };
            break;
          case 17:
            this.$ = { path: $$[$02 - 4], params: $$[$02 - 3], hash: $$[$02 - 2], blockParams: $$[$02 - 1], strip: yy.stripFlags($$[$02 - 5], $$[$02]) };
            break;
          case 18:
            this.$ = { strip: yy.stripFlags($$[$02 - 1], $$[$02 - 1]), program: $$[$02] };
            break;
          case 19:
            var inverse = yy.prepareBlock($$[$02 - 2], $$[$02 - 1], $$[$02], $$[$02], false, this._$), program = yy.prepareProgram([inverse], $$[$02 - 1].loc);
            program.chained = true;
            this.$ = { strip: $$[$02 - 2].strip, program, chain: true };
            break;
          case 20:
            this.$ = $$[$02];
            break;
          case 21:
            this.$ = { path: $$[$02 - 1], strip: yy.stripFlags($$[$02 - 2], $$[$02]) };
            break;
          case 22:
            this.$ = yy.prepareMustache($$[$02 - 3], $$[$02 - 2], $$[$02 - 1], $$[$02 - 4], yy.stripFlags($$[$02 - 4], $$[$02]), this._$);
            break;
          case 23:
            this.$ = yy.prepareMustache($$[$02 - 3], $$[$02 - 2], $$[$02 - 1], $$[$02 - 4], yy.stripFlags($$[$02 - 4], $$[$02]), this._$);
            break;
          case 24:
            this.$ = {
              ...
              hash: $$[$02 - 1],
              indent: "",
              strip: yy.stripFlags($$[$02 - 4], $$[$02]),
              loc: yy.locInfo(this._$)
            };
            break;
          case 25:
            this.$ = yy.preparePartialBlock($$[$02 - 2], $$[$02 - 1], $$[$02], this._$);
            break;
          case 26:
            this.$ = { path: $$[$02 - 3], params: $$[$02 - 2], hash: $$[$02 - 1], strip: yy.stripFlags($$[$02 - 4], $$[$02]) };
            break;
          case 27:
            this.$ = $$[$02];
            break;
          ...
          case 29:
            ...
            break;
          case 30:
            this.$ = { type: "Hash", pairs: $$[$02], loc: yy.locInfo(this._$) };
            break;
          case 31:
            this.$ = { type: "HashPair", key: yy.id($$[$02 - 2]), value: $$[$02], loc: yy.locInfo(this._$) };
            break;
          case 32:
            this.$ = yy.id($$[$02 - 1]);
            break;
          ...
          case 34:
            ...
            break;
          case 35:
            this.$ = { type: "StringLiteral", value: $$[$02], original: $$[$02], loc: yy.locInfo(this._$) };
            break;
          case 36:
            this.$ = { type: "NumberLiteral", value: Number($$[$02]), original: Number($$[$02]), loc: yy.locInfo(this._$) };
            break;
          case 37:
            this.$ = { type: "BooleanLiteral", value: $$[$02] === "true", original: $$[$02] === "true", loc: yy.locInfo(this._$) };
            break;
          case 38:
          ...
          case 41:
            ...
            break;
          case 42:
            this.$ = yy.preparePath(true, $$[$02], this._$);
            break;
          case 43:
            this.$ = yy.preparePath(false, $$[$02], this._$);
            break;
          case 44:
            $$[$02 - 2].push({ part: yy.id($$[$02]), original: $$[$02], separator: $$[$02 - 1] });
            this.$ = $$[$02 - 2];
            break;
          case 45:
            this.$ = [{ part: yy.id($$[$02]), original: $$[$02] }];
            break;
          case 46:
            this.$ = [];
            break;
...
var require_whitespace_control = __commonJS((exports, module) => {
  ...
  var isPrevWhitespace = function(body, i2, isRoot) {
    if (i2 === undefined) {
      i2 = body.length;
    }
  ...
  var isNextWhitespace = function(body, i2, isRoot) {
    if (i2 === undefined) {
      i2 = -1;
    }
  ...
  var omitRight = function(body, i2, multiple) {
  ...
  var omitLeft = function(body, i2, multiple) {
...
var require_quick_sort = __commonJS((exports) => {
  ...
  var doQuickSort = function(ary, comparator, p2, r2) {
    if (p2 < r2) {
...
var require_javascript_compiler = __commonJS((exports, module) => {
  ...
  var strictLookup = function(requireTerminal, compiler, parts, i2, type) {
  ...
  JavaScriptCompiler.prototype = {
    ...
    compile: function compile(environment, options, context, asObject) {
      ...
      var opcodes = environment.opcodes, opcode = undefined, firstLoc = undefined, i2 = undefined, l2 = undefined;
...
var require_handlebars = __commonJS((exports, module) => {
  ...
  var create = function() {
    var hb2 = _create();
    hb2.compile = function(input, options) {
      return _handlebarsCompilerCompiler.compile(input, options, hb2);
    };
    hb2.precompile = function(input, options) {
      return _handlebarsCompilerCompiler.precompile(input, options, hb2);
    };
    hb2.AST = _handlebarsCompilerAst2["default"];
    hb2.Compiler = _handlebarsCompilerCompiler.Compiler;
    hb2.JavaScriptCompiler = _handlebarsCompilerJavascriptCompiler2["default"];
    hb2.Parser = _handlebarsCompilerBase.parser;
    hb2.parse = _handlebarsCompilerBase.parse;
    hb2.parseWithoutProcessing = _handlebarsCompilerBase.parseWithoutProcessing;
    return hb2;
  };
  exports.__esModule = true;
...
var inputClasses = "z-[1] peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-150 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0";
var labelClasses = "z-[1] pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-150 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary";
...
var elementBoundEffect = function(el2) {
  let cleanup2 = () => {
  };
  let wrappedEffect = (callback) => {
    let effectReference = effect(callback);
    if (!el2._x_effects) {
      el2._x_effects = new Set;
      el2._x_runEffects = () => {
...
var onElRemoved = function(el2, callback) {
...
var onAttributeRemoved = function(el2, name, callback) {
...
var cleanupAttributes = function(el2, names) {
  if (!el2._x_attributeCleanups)
    return;
...
var cleanupElement = function(el2) {
  if (el2._x_cleanups) {
...
var injectMagics = function(obj, el2) {
  Object.entries(magics).forEach(([name, callback]) => {
    ...
    Object.defineProperty(obj, `\$${name}`, {
      get() {
        return callback(el2, getUtilities());
      },
      enumerable: false
    });
  });
...
var tryCatch = function(el2, expression, callback, ...args) {
  try {
...
var handleError = function(error2, el2, expression = undefined) {
  error2 = Object.assign(error2 ?? { message: "No error message given." }, { el: el2, expression });
...
var evaluate = function(el2, expression, extras = {}) {
  let result;
...
var normalEvaluator = function(el2, expression) {
...
var generateFunctionFromString = function(expression, el2) {
...
var generateEvaluatorFromString = function(dataStack, expression, el2) {
  ...
  return (receiver = () => {
    ...
    if (typeof func === "function") {
      ...
      if (func.finished) {
        ...
        }).catch((error2) => handleError(error2, el2, expression)).finally(() => func.result = undefined);
      }
    }
  };
};
var runIfTypeOfFunction = function(receiver, value, scope2, params, el2) {
...
var directives = function(el2, attributes, originalAttributeOverride) {
...
var getElementBoundUtilities = function(el2) {
  let cleanups = [];
...
var getDirectiveHandler = function(el2, directive2) {
  let noop = () => {
  };
...
var dispatch = function(el2, name, detail = {}) {
...
var walk = function(el2, callback) {
...
var closestRoot = function(el2, includeInitSelectors = false) {
...
var findClosest = function(el2, callback) {
  if (!el2)
    return;
  if (callback(el2))
    return el2;
...
var setClasses = function(el2, value) {
...
var setClassesFromString = function(el2, classString) {
...
var setClassesFromObject = function(el2, classObject) {
...
var setStylesFromString = function(el2, value) {
...
var registerTransitionsFromClassString = function(el2, classString, stage) {
...
var registerTransitionsFromHelper = function(el2, modifiers, stage) {
...
var registerTransitionObject = function(el2, setFunction, defaultValue = {}) {
...
var closestHide = function(el2) {
  let parent = el2.parentNode;
  if (!parent)
    return;
  return parent._x_hidePromise ? parent : closestHide(parent);
};
var transition = function(el2, setFunction, { during, start: start2, end } = {}, before = () => {
}, after = () => {
}) {
...
var performTransition = function(el2, stages) {
  ...
  requestAnimationFrame(() => {
    if (interrupted)
      return;
    let duration = Number(getComputedStyle(el2).transitionDuration.replace(/,.*/, "").replace("s", "")) * 1000;
    let delay = Number(getComputedStyle(el2).transitionDelay.replace(/,.*/, "").replace("s", "")) * 1000;
    if (duration === 0)
      duration = Number(getComputedStyle(el2).animationDuration.replace("s", "")) * 1000;
    mutateDom(() => {
      stages.before();
    });
    reachedBefore = true;
...
var bind = function(el2, name, value, modifiers = []) {
  if (!el2._x_bindings)
...
var bindInputValue = function(el2, value) {
  if (el2.type === "radio") {
    if (el2.attributes.value === undefined) {
      el2.value = value;
    }
    if (window.fromModel) {
...
var setIfChanged = function(el2, attrName, value) {
  if (el2.getAttribute(attrName) != value) {
    el2.setAttribute(attrName, value);
  }
};
var setPropertyIfChanged = function(el2, propName, value) {
  if (el2[propName] !== value) {
    el2[propName] = value;
  }
};
var updateSelect = function(el2, value) {
...
var getBinding = function(el2, name, fallback) {
  if (el2._x_bindings && el2._x_bindings[name] !== undefined)
    return el2._x_bindings[name];
  return getAttributeBinding(el2, name, fallback);
};
var extractProp = function(el2, name, fallback, extract = true) {
  if (el2._x_bindings && el2._x_bindings[name] !== undefined)
    return el2._x_bindings[name];
  if (el2._x_inlineBindings && el2._x_inlineBindings[name] !== undefined) {
...
var getAttributeBinding = function(el2, name, fallback) {
...
var applyBindingsObject = function(el2, obj, original) {
  let cleanupRunners = [];
...
var isEffect = function(fn2) {
  return fn2 && fn2._isEffect === true;
};
var effect2 = function(fn2, options = EMPTY_OBJ) {
  if (isEffect(fn2)) {
    fn2 = fn2.raw;
  }
...
var createReactiveEffect = function(fn2, options) {
...
var isRef = function(r2) {
  return Boolean(r2 && r2.__v_isRef === true);
};
var getArrayOfRefObject = function(el2) {
  let refObjects = [];
  findClosest(el2, (i2) => {
    if (i2._x_refs)
...
var closestIdRoot = function(el2, name) {
  return findClosest(el2, (element) => {
    if (element._x_ids && element._x_ids[name])
      return true;
  });
};
var setIdRoot = function(el2, name) {
  if (!el2._x_ids)
    el2._x_ids = {};
  if (!el2._x_ids[name])
    el2._x_ids[name] = findAndIncrementId(name);
};
var cacheIdByNameOnElement = function(el2, cacheKey, cleanup2, callback) {
  if (!el2._x_id)
    el2._x_id = {};
...
var on2 = function(el2, event, modifiers, callback) {
...
var isListeningForASpecificKeyThatHasntBeenPressed = function(e2, modifiers) {
...
var getInputValue = function(el2, modifiers, event, currentValue) {
  return mutateDom(() => {
...
var storeKeyForXFor = function(el2, expression) {
  el2._x_keyExpression = expression;
};
var shouldSkipRegisteringDataDuringClone = function(el2) {
  if (!isCloning)
    return false;
  if (isCloningLegacy)
    return true;
...
var loop = function(el2, iteratorNames, evaluateItems, evaluateKey) {
...
directive("model", (el2, { modifiers, expression }, { effect: effect3, cleanup: cleanup2 }) => {
  ...
  } : on2(el2, event, modifiers, (e2) => {
    setValue(getInputValue(el2, modifiers, e2, getValue()));
  });
  if (modifiers.includes("fill")) {
    if ([undefined, null, ""].includes(getValue()) || el2.type === "checkbox" && Array.isArray(getValue()) || el2.tagName.toLowerCase() === "select" && el2.multiple) {
      setValue(getInputValue(el2, modifiers, { target: el2 }, getValue()));
    }
  }
  ...
  if (el2.form) {
    let removeResetListener = on2(el2.form, "reset", [], (e2) => {
...
directive("show", (el2, { modifiers, expression }, { effect: effect3 }) => {
  ...
  if (!el2._x_doHide)
    el2._x_doHide = () => {
      mutateDom(() => {
        el2.style.setProperty("display", "none", modifiers.includes("important") ? "important" : undefined);
      });
    };
  if (!el2._x_doShow)
    el2._x_doShow = () => {
...
directive("on", skipDuringClone((el2, { value, modifiers, expression }, { cleanup: cleanup2 }) => {
  ...
  let removeListener = on2(el2, value, modifiers, (e2) => {
    evaluate2(() => {
...
// src/main/resources/META-INF/resources/js/receipts.js
var receiptZipDialogForm;
var zipDialogData;
var dataEmailZip;
var emailZipDialogBtnSubmit;
var emailsZip;
var emailZipTemplate;
window.initReceipt = function() {
  receiptZipDialogForm = document.getElementById("send-zip-form");
...
document.body.addEventListener("htmx:afterSettle", function(configEvent) {
  let elements2 = document.getElementsByClassName("hidden-to-be-removed");
